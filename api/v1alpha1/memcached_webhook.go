...
// +kubebuilder:webhook:path=/mutate-cache-app-com-v1alpha1-memcached,mutating=true,failurePolicy=fail,groups=cache.app.com,resources=memcacheds,verbs=create;update,versions=v1alpha1,name=mmemcached.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cache-app-com-v1alpha1-memcached,mutating=false,failurePolicy=fail,groups=cache.app.com,resources=memcacheds,versions=v1alpha1,name=vmemcached.kb.io
